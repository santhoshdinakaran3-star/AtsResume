  ...
  return (
    <>
      ...
      <div className="page-container">
        <motion.div initial={{ opacity: 0, y: 25 }} animate={{ opacity: 1, y: 0 }} style={{ marginBottom: '2rem', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
          <div>
        ...
        {match && (
          <FloatingCard delay={0.7} style={{ marginBottom: '1.25rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '155px 1fr 1fr', gap: '1.25rem', alignItems: 'start' }}>
